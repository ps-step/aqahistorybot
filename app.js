...
const spainNotesData = {
    ...
    "Philip II - Foreign Policy (not Netherlands)": [
        ...
        { type: "bullet", text: "Henry II renewed hostilities to gain Italian territory, but finances led to truce at [[Vaucelles]]." },
        ...
        { type: "bullet", text: "Philip's attempt to install [[Infanta Isabella]] failed due to French adherence to [[Salic Law]] and nationalistic backlash." },
