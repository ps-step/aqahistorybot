...
import { getFirestore, doc, getDoc, setDoc, collection, query, getDocs } from "https://www.gstatic.com/firebasejs/10.8.1/firebase-firestore.js";
...
const spainCats = [
    "Ferdinand and Isabella: Economics", "Ferdinand and Isabella: Foreign Policy", "Ferdinand and Isabella: Religious Policy", 
    "Ferdinand and Isabella: Government, Authority, and Administation", "Ferdinand and Isabella: Santa Hermandad",
    "Charles V: Consolidation and Revolts", "Charles V: Economics", "Charles V: Foreign Policy", "Charles V: Government, Authority, and Administration", 
    "Charles V: New World", "Charles V: Religious Policy", "Philip II: Dutch Revolt", "Philip II: Economics", "Philip II: Foreign Policy", 
    "Philip II: Revolts", "Philip II: Government, Authority, and Administation", "Philip II: Religious Policy"
];
...
const spainNotesData = {
    "Ferdinand and Isabella: Government, Authority, and Administation": [
        { type: "heading", text: "War of Succession" },
        { type: "bullet", text: "[[War of Succession]]: Isabella was kept captive by her guardian, the [[Marquis of Villena]]." },
        { type: "bullet", text: "[[Joanna Beltraneja]] threatened the crown. The Archbishop of [[Toledo]] supported Joanna with [[19,000]] men and [[20]] castles."},
        { type: "bullet", text: "Isabella won at [[1476]] Battle of [[Toro]]."},
        { type: "bullet", text: "Ended by [[1479]] [[Treaty of Alcacovas]]. Castile granted everything north of and including [[Canaries]]. Beltraneja was sent to a [[convent]]." },
        ...
        { type: "bullet", text: "The [[1494]] Cortes of Aragon appointed [[viceroys]]." },
        { type: "bullet", text: "The Castilian cortes did not meet from [[1482]] to [[1498]]." },
        { type: "bullet", text: "[[Mayorazgos]] were promoted by the [[1505]] Cortes of [[Toro]]. Prevented the [[sale]] and [[division]] of estates." },
        { type: "heading", text: "Royal Authority" },
        { type: "bullet", text:  "The [[fueros]] and separate cortes of [[Aragon]] were retained."},
        ...
        { type: "heading", text: "Councils" },
        { type: "bullet", text: "The [[Royal Council]] was professionalised in a [[1493]] pragmatica. [[Ten years]] of legal training was required to sit on the council." },
    ...
    "Ferdinand and Isabella: Foreign Policy": [
        ...
        { type: "bullet", text: "[[1493 Treaty of Barcelona]] recovered [[Cerdagne]], [[Rousillion]]." },
        ...
        { type: "heading", text: "Italy" },
        { type: "bullet", text: "[[1495]]: Disastrous defeat at the [[Battle of Seminara]] motivated Cordoba to change tactics to have less pitched battles - precursor of [[tercios]]." },
        { type: "bullet", text: "[[Gonzalo de Cordoba]] 'the Grand Captain' won victors at Cerignola and Garigliano [[1503]]. Ferdinand as king of Naples by [[1504]]." },
        { type: "heading", text: "England" },
        { type: "bullet", text: "First resident ambassadors in [[London]] in [[1487]]. [[1489 Treaty of Medina del Campo]] secured [[English]] alliance w/ marriages." },
        { type: "heading", text: "Portugal" },
        { type: "bullet", text: "[[1479 Treaty of Alcacovas]] secured [[Canaries]], conquered by [[1496]]. [[1494 Treaty of Tordesillas]] divided the globe." },
        { type: "heading", text: "North Africa" },
        { type: "bullet", text: "[[Presidios]] were established. [[1497]] Melilla, [[1505]] Mers-el-Kebir, [[1509]] Oran." },
        { type: "heading", text: "Navarre" },
        { type: "bullet", text: "Succession crisis exploited to annexation in [[1512]]. Ferdinand as king. Respected [[fueros]]." },
        { type: "heading", text: "Americas" },
    ...
    "Ferdinand and Isabella: Economics": [
        ...
        { type: "bullet", text: "Revenue went from [[800k reales]] in [[1470]] to [[22m reales]] in [[1504]]." },
        ...
        { type: "bullet", text: "The mesta had [[2.8 million]] sheep in [[1450]]. It was protected by the crown. Special interest represented on the [[royal council]]. Lack of agriculture led to reliance on imports and wheat shortage by [[1506]]. [[1501 Law of Leases]] allowed Mesta to rent land in perpetuity at the original price. [[Tasa]] (price fix) on grain in [[1502]] tried to fight this." },
        { type: "heading", text: "Debt" },
        { type: "bullet", text: "[[Juros]] (10% interest bonds) given out. Repayment reached [[131 million maravedis]] by [[1516]]." },
        { type: "heading", text: "Trade" },
        { type: "bullet", text: "The [[1497]] pragmatica standardised [[375 maravedis]] as 1 [[ducat]], [[excelente]], [[principat]]." },
    ...
    "Charles V: Consolidation and Revolts": [
        ...
        { type: "bullet", text: "[[1520-21 Comuneros]]: Urban uprising due to [[high taxes]], [[foreigners]], [[corregidor abuses]]. [[Toledo]], [[Segovia]]. Led by [[Juan de Padilla]]. Radicalised by burning of [[Medina del Campo]] in [[1520]] on orders of Charles. Failed to get [[Joanna the Mad's]] support." },
    ...
    "Charles V: Government, Authority, and Administration": [
        ...
        { type: "bullet", text: "[[1523]]: Pope granted permanent mastership of the [[military orders]] and expanded [[1486 Patronato Real]] to all of Spain." },
        { type: "heading", text: "Administration" },
        { type: "bullet", text: "[[1543]]: State archive established at [[Simancas]]." },
        { type: "bullet", text: "[[1543]]: Philip as regent, aged [[16]]. Guided by junta including Cardinal [[Tavera]] and [[los Cobos]]. Lasted for [[14yrs]] during Charles' absence." },
    ...
    "Charles V: Economics": [
        ...
        { type: "bullet", text: "[[1543 almojarifazgo mayor]]: [[5%]] customs duty on bullion via [[Seville]]." },
        { type: "bullet", text: "[[1540s]]: desperate measures eg. seizing all private [[treasure]] imported to fund [[Muhlberg]]." },
        { type: "bullet", text: "[[1544]]: [[1000 hidalgos]] auctioned to raise money. Backfired as they were exempt from taxation. Selling [[public offices]] weakened crown jurisdiction in the long term." },
        { type: "bullet", text: "[[1516-60]]: [[11.9m ducats]] from Americas. Partially result of [[Potosi]] [[1545]] and [[Zacatecas]] [[1548]]. [[1554 mercury amalgamation]] was new process to extract silver ore." },
        { type: "heading", text: "Debt" },
        ...
        { type: "bullet", text: "Until [[1555]]: Navy contracted out to [[Genoa]], which was unsustainable." },
        { type: "bullet", text: "[[1556]]: [[36 million ducats]] of debt. Bankrupt by [[1557]]. Total failure." },
        { type: "heading", text: "Price Revolution" },
    ...
    "Philip II: Government, Authority, and Administation": [
        { type: "heading", text: "Madrid" },
        ...
        { type: "bullet", text: "[[1567 Nueva Recopilacion]] codified laws of Castile." },
        ...
        { type: "bullet", text: "[[1590]]s: only [[35%]] of land in Salamanca and [[73/300]] towns in Valencia under direct royal jurisdiction." },
        { type: "bullet", text: "Mandatory end-of-term judicial reviews ([[residencias]]) improved administration." },
        { type: "heading", text: "Factionalism" },
        { type: "bullet", text: "[[Alba]] had the war party and [[Eboli]] the peace party. Philip failed to back either one decisively; unnecessary conflict and slow bureaucracy." },
        { type: "bullet", text: "[[31 March 1578]]: [[Juan de Escobedo]] (secretary of Don John) ambushed and stabbed to death by assassins hired by Perez. July [[1579]]: Philip ordered arrest of Perez and Princess of Eboli. Perez possessed compromising state documents (proving the King ordered hit), Philip spent years alternating between torturing him and treating him leniently to get the papers back." }
    ],
    "Philip II: Religious Policy": [
        ...
        { type: "heading", text: "Protestants" },
        { type: "bullet", text: "Protestant Cells ([[1557-58]]) in [[Seville]] ([[130]]-[[150]] people) and [[Valladolid]] ([[55]] people) - panic." },
        { type: "bullet", text: "Protestantism effectively eradicated by [[1562]] ([[278]] prosecutions, [[77]] deaths) in autos-de-fes." },
        ...
        { type: "bullet", text: "[[1567]] Edict forbade Arabic language, Moorish dress, and traditional names, triggering the [[1568-70 Alpujarras revolt]]." },
    ...
    "Philip II: Economics": [
        ...
        { type: "heading", text: "Debt and Bankruptcies" },
        ...
        { type: "bullet", text: "Bankruptcies in [[1557]], [[1560]], [[1575]], and [[1596]]." },
        ...
        { type: "heading", text: "Military Spending" },
        { type: "bullet", text: "Dutch revolt cost approximately [[80 million ducats]]." },
        { type: "bullet", text: "1588 Armada cost [[10 million ducats]]." },
        { type: "bullet", text: "Lepanto campaign cost the Castilian exchequer [[5 million ducats]]; direct cost of the battle was [[1.1 million ducats]]" }
    ],
    "Philip II: Revolts": [
        ...
        { type: "bullet", text: "A rebel army of [[30,000]] was led by [[Aben Humeya]] (Fernando de Valor); it was suppressed with extreme brutality by [[Don John]] who brought [[12k]] (later up to [[25k]]) men. Tercio veterans." },
        { type: "bullet", text: "[[Seron]]: Rebels killed [[150]] and enslaved [[80]]." },
        { type: "bullet", text: "Siege of [[Galera]] ([[1570]]): Royal forces razed the village and slaughtered [[2500]] inhabitants. Many atrocities comitted." },
        ...
        { type: "bullet", text: "[[Zaragoza Riots]] ([[1591]]): Mobs attacked the Inquisition prison to stop Perez’s transfer; the Viceroy [[Almenara]] was fatally wounded." },
        { type: "bullet", text: "[[1591]] Invasion: Philip sent [[14,000]] soldiers under [[Alonso de Vargas]] to restore order; a small rebel force of [[2000]] dispersed. The rebels only ever occupied [[Zaragoza]]. Most of Aragon did not join." },
    ...
    "Philip II: Foreign Policy": [
        { type: "heading", text: "General Strategy and Cost" },
        ...
        { type: "bullet", text: "[[1565 Siege of Malta]]: [[9000]] Knights held out against [[30,000]] Ottomans for four months until [[Garcia de Toledo]] relieved." },
        { type: "bullet", text: "[[7 October 1571]] Battle of [[Lepanto]]: Holy League victory; [[12,000]] Christian rowers liberated and killed [[30,000]] Turks. Christian fleet included [[80]] Spanish galleys. Over [[210]] Turkish ships lost, including [[117]] galleys good enough to be used by Christians." },
...
const wotrNotesData = {
    "1450-1458": [
        ...
        { type: "bullet", text: "<b>[[22 May 1455]]</b> - First Battle of [[St. Albans]] - [[Yorkist]] victory. In a short battle which lasted probably about an hour, about [[160]] casualties occur, of which most are nobles and officers. These include [[Northumberland]], [[Clifford]], and [[Somerset]], who were killed, and Henry VI, who is wounded by an arrow to the [[shoulder]]. The battle featured about [[5000]] troops. The Yorkists are definitively in control following the engagement." },
    ...
    "1485-1499": [
        ...
        { type: "bullet", text: "<b>[[7 November 1485]]</b> - Henry VII's first Parliament met; the [[Titulus Regius]] is revoked and some new titles are invested like Jasper Tudor as Duke of Bedford. There was also an act against [[retaining]] which reduced the power of the nobility." },
        ...
        { type: "heading", text: "Economy and Acts" },
        { type: "bullet", text: "<b>[[1485]]</b> - Henry VII raised [[£10,000]] in loans due to inheriting a bankrupt economy. He was able to repay these." },
        { type: "bullet", text: "<b>[[1487]]</b> - The [[Star Chamber]] was established which heard cases against nobles." },
        { type: "bullet", text: "<b>[[1488-1489]]</b> - Acts were passed to prevent [[depopulation]] due to enclosure but these were sparingly enforced." },
        { type: "bullet", text: "<b>[[1491]]</b> - Henry VII used [[benevolences]] to raise [[£48,000]] for the invasion of France." },
        { type: "bullet", text: "<b>[[1493]]</b> - Henry VII began to bypass the [[Exchequer]], similar to Edward IV." },
        { type: "bullet", text: "<b>[[1495]]</b> - The [[Council Learned in the Law]] was established under [[Sir Reginald Bray]] which enforced the system of bonds and recognisances." },
        { type: "heading", text: "Rebellions" },
        ...
        { type: "heading", text: "Foreign Policy" },
        ...
        { type: "bullet", text: "<b>[[30 September 1497]]</b> - In the Treaty of [[Ayton]], England agreed a [[seven]] year truce with Scotland." },
        ...
        { type: "bullet", text: "<b>[[November 1491]]</b> - Warbeck arrived in [[Cork]], where he was proclaimed as first the [[Earl of Warwick]] and then the [[Duke of York]] and gained the support of the [[Earl of Desmond]], John Taylor, and John Atwater." },
        ...
        { type: "bullet", text: "<b>[[6 July 1497]]</b> - James IV expelled Warbeck, as he wished to establish a truce with Henry VII whereby he could marry [[Margaret Tudor]]." },
